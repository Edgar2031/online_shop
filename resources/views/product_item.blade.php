                    ...
                    <div class="container">
                        <div class="row row-wrap">
                            <div class="col-md-3">
                                ...
                                <p>Mattis eros curae rutrum cursus metus lacus cras ante consectetur congue mus imperdiet torquent curae orci tortor dictumst ante luctus</p>
                            </div>
                            <div class="col-md-3">
                                ...
                                <div class="box">
                                    <form>
                                        ...
                                        <p class="mb10">Orci platea tempus gravida cras felis cum</p>
                                ...
                                <ul class="thumb-list">
                                    <li>
                                        ...
                                        <div class="thumb-list-item-caption">
                                            ...
                                            <h5 class="thumb-list-item-title"><a href="#">Mi netus</a></h5>
                                            <p class="thumb-list-item-desciption">Dui phasellus tempor ante inceptos</p>
                                        </div>
                                    </li>
                                    <li>
                                        <a href="#">
                                        ...
                                        <div class="thumb-list-item-caption">
                                            <p class="thumb-list-item-meta">Jul 18, 2014</p>
                                            <h5 class="thumb-list-item-title"><a href="#">Ornare eleifend</a></h5>
                                            <p class="thumb-list-item-desciption">Cum dis phasellus dictumst nisl</p>
                                        </div>
                                    </li>
                                    <li>
                                        <a href="#">
                                        ...
                                        <div class="thumb-list-item-caption">
                                            <p class="thumb-list-item-meta">Jul 18, 2014</p>
                                            <h5 class="thumb-list-item-title"><a href="#">Velit elementum</a></h5>
                                            <p class="thumb-list-item-desciption">Sociosqu odio mauris facilisis ridiculus</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
