...
<html lang="en">
                    ...
                    <div class="col-md-3">
                        <aside class="sidebar-left">
                            <ul class="nav nav-pills nav-stacked nav-arrow">
                                ...
                                <li class="active"><a href="page-my-account-wishlist.html">Product</a>
                                </li>
                            </ul>
                        </aside>
                    </div>
                    ...
                    <div class="container">
                        <div class="row row-wrap">
                            <div class="col-md-3">
                                ...
                                <p>Consectetur hendrerit euismod dapibus vestibulum vel bibendum quisque ac quis hac ut porttitor tempus fringilla molestie ad ultrices proin turpis</p>
                            </div>
                            <div class="col-md-3">
                                ...
                                <div class="box">
                                    <form>
                                        ...
                                        <p class="mb10">Turpis arcu etiam maecenas mi consectetur vestibulum</p>
                                ...
                                <ul class="thumb-list">
                                    <li>
                                        ...
                                        <div class="thumb-list-item-caption">
                                            ...
                                            <h5 class="thumb-list-item-title"><a href="#">Lorem pulvinar</a></h5>
                                            <p class="thumb-list-item-desciption">Feugiat urna justo habitant eros</p>
                                        </div>
                                    </li>
                                    <li>
                                        <a href="#">
                                        ...
                                        <div class="thumb-list-item-caption">
                                            <p class="thumb-list-item-meta">Jul 18, 2014</p>
                                            <h5 class="thumb-list-item-title"><a href="#">Auctor ut</a></h5>
                                            <p class="thumb-list-item-desciption">Tristique tempus class nostra conubia</p>
                                        </div>
                                    </li>
                                    <li>
                                        <a href="#">
                                        ...
                                        <div class="thumb-list-item-caption">
                                            <p class="thumb-list-item-meta">Jul 18, 2014</p>
                                            <h5 class="thumb-list-item-title"><a href="#">Mauris libero</a></h5>
                                            <p class="thumb-list-item-desciption">Morbi elementum adipiscing conubia fringilla</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
    ...
    {{-- Ptoduct Remove --}}
    <script src="{{asset('js/pro_remove.js')}}"></script>
</html>
@endsection